...
INTERNAL_POSITION_UPDATES_QUEUE = "tq_internal_position_updates"
INTERNAL_ACCOUNT_UPDATES_QUEUE = "tq_internal_account_updates"

# Routing Keys
ROUTING_KEY_ORDER_UPDATES = "order_updates"
ROUTING_KEY_POSITION_UPDATES = "position_updates"
...
REDIS_POSITION_BREAKDOWN_KEY_PATTERN = "TQ_Position_Breakdown_PortfolioId_{portfolio_id}_Symbol_{symbol}"
REDIS_ACCOUNT_KEY_PATTERN = "TQ_Account_PortfolioId_{portfolio_id}"

# TTL in seconds
POSITION_TTL = 3600  # 1 hour
ACCOUNT_TTL = 3600   # 1 hour
POSITION_BREAKDOWN_TTL = 3600  # 1 hour
